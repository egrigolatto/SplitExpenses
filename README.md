...
- [x] Definir la visión del proyecto.
- [x] Identificar objetivos y no objetivos.
- [x] Definir funcionalidades.
- [x] Especificar requisitos.
- [x] Diseñar el flujo del usuario.
- [x] Crear wireframes.
- [x] Modelar el dominio.
- [x] Definir la arquitectura.
- [x] Seleccionar el stack tecnológico.
...
- [ ] Definir contratos de la API.
- [ ] Planificar autenticación.

## Fase 3 — Desarrollo

- [ ] Implementar backend.
- [ ] Implementar frontend.
- [ ] Integrar ambas aplicaciones.
- [ ] Agregar autenticación.
- [ ] Incorporar historial y estadísticas.